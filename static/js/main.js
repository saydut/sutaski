...
// ... (initOfflineState, baslangicVerileriniYukle, ozetVerileriniYukle, girdileriGoster, tedarikcileriYukle fonksiyonları aynı kalır) ...
/**
...
window.onload = async function() {
    ...
    if (kullaniciRolu === 'ciftci') {
        ...
        checkForUpdates(); // YENİ: Güncelleme kontrolünü çiftçi için de yapalım
    ...
    checkForUpdates(); // YENİ: PWA güncelleme kontrolünü başlat
};
...
// ====================================================================================
// ... (mevcut girdileriFiltrele, filtreyiTemizle, sutGirdisiEkle, degeriDogrulaVeKaydet, gercekKaydetmeIsleminiYap, sutGirdisiDuzenle, sutGirdisiSil, sifreDegistir, verileriDisaAktar, gorunumuDegistir, gorunumuAyarla fonksiyonları burada kalacak) ...
// ... existing code ...
